...
class _LogGenerator():
    ...
    def __init__(
        ...
        :param log_fmt: initialize log formatter either with the specified format string, or a default as described above, defaults to '[%(asctime)s - %(levelname)s] : %(message)s'
...
logger = _LogGenerator('ChooseMyGame', 'logs/ChooseMyGameLog.log')
